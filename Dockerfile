...
WORKDIR /opt
RUN sudo rm -rf /opt/hadoop && wget $HADOOP_URL --no-check-certificate -O hadoop.tar.gz && tar zxf hadoop.tar.gz && rm hadoop.tar.gz && mv hadoop* hadoop && rm -rf /opt/hadoop/share/doc
WORKDIR /opt/hadoop
